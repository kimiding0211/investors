...
<div class="card card-primary card-outline mb-4">
    ...
    <div class="card-body">
        ...
        <select name="quarterly">
            ...
            <option value="Q3" <?php if($rs[0]['quarterly']=="Q3"){echo 'selected';} ?>>Q3</option>
            <option value="Q4" <?php if($rs[0]['quarterly']=="Q4"){echo 'selected';} ?>>Q4</option>
        </select>
        </div>
        ...
        <?php if(isset($rs[0]['link_en'])){ ?>
        <a href='<?php echo $rs[0]['link_en']; ?>' target='_blank'>檔案預覽</a>
        <?php } ?>
