...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($file_status_cn && $file_status_en) {
        ...
        $link_cn = (!empty($fileName_cn)) ? 'http://localhost/investors/admin/dist/images/conference/'.$years.'/'.$fileName_cn : '';
        $link_en = (!empty($fileName_en)) ? 'http://localhost/investors/admin/dist/images/conference/'.$years.'/'.$fileName_en : '';
