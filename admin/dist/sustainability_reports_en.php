...
$sql = " select * from sustainability_reports_en ";
    ...
    <div class="col-md-6" style="width:100%">
        <div class="card mb-4">
            <div class="card-header">
                <h3 class="card-title">永續發展-永續報告與發展政策-英文</h3>
                <div class="text-end">
                    <a href="sustainability_reports_en_ins.php" class="btn">
            ...
            <table class="table table-bordered">
                ...
                <tr class="align-middle">
                    ...
                    <?php } ?>
                    <td>
                        <a href="sustainability_reports_en_edit.php?id=<?php echo $rs[$i]['id'];  ?>" class="btn"  style="width=11%">
                        ...
                        <a href="sustainability_reports_en_del.php?id=<?php echo $rs[$i]['id'];  ?>" class="btn" onclick="return confirm('確定刪除這筆資料？')" style="width=11%">
