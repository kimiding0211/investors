...
if ($file_status) {
    ...
    $sql = " update sustainability_reports_en set project_name='$project_name', title='$title', status=$status ";
    ...
    $pdo->query($sql);
    echo "<script>alert('資料已更新');window.location.href='sustainability_reports_en.php';</script>";
}else{
