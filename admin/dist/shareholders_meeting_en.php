...
$sql = " select * from shareholders_meeting_en ";
    ...
    <div class="col-md-6" style="width:100%">
        <div class="card mb-4">
            <div class="card-header">
                <h3 class="card-title">股務資訊-股東會-英文</h3>
                <div class="text-end">
                    <a href="shareholders_meeting_en_ins.php" class="btn">
            ...
            <table class="table table-bordered">
                ...
                <tr class="align-middle">
                    ...
                    <?php } ?>
                    <td>
                        <a href="shareholders_meeting_en_edit.php?id=<?php echo $rs[$i]['id'];  ?>" class="btn"  style="width=11%">
                        ...
                        <a href="shareholders_meeting_en_del.php?id=<?php echo $rs[$i]['id'];  ?>" class="btn" onclick="return confirm('確定刪除這筆資料？')" style="width=11%">
