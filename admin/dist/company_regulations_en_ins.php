...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($file_status) {
        ...
        $sql = " insert into company_regulations_en set title='$title', project_name='$project_name', status=$status ";
        if(!empty($fileName)){
        ...
        $sql = " insert into ins_log set user='$admin', menu='新增內部規章與治理機制-英文', datetime='$now' ";
        $pdo->query($sql);
        echo "<script>alert('資料已新增');window.location.href='company_regulations_en.php';</script>";
    }else{
...
<div class="card card-primary card-outline mb-4">
    ...
    <div class="card-body">
        ...
        <select name="project_name">
            <option value="內部規章">內部規章</option>
            <option value="治理機制">治理機制</option>
        </select>
        </div>
        <div class="mb-3">
    ...
    <div class="card-footer">
        ...
        <a href="company_regulations_en.php" class="btn btn-primary">返回</a>
    </div>
    <!--end::Footer-->
    </form>
    <!--end::Form-->
