...
<div class="card card-primary card-outline mb-4">
    ...
    <!--end::Header-->
    <!--begin::Form-->
    <form action="remuneration_content_edit_1.php" method="post">
    <!--begin::Body-->
    <div class="card-body">
    ...
    <div class="card-footer">
        ...
        <a href="remuneration_content_edit_2.php?id=<?php echo $rs[0]['id']; ?>" class="btn btn-primary">發布</a>
        <?php } ?>
        <a href="remuneration_content.php" class="btn btn-primary">返回</a>
    </div>
    <!--end::Footer-->
    </form>
    <!--end::Form-->
