    ...
    <div class="col-md-6" style="width:100%">
        <div class="card mb-4">
            <div class="card-header">
                <h3 class="card-title">最新消息-分類管理</h3>
                <div class="text-end">
                    <a href="news_mark_ins.php" class="btn">
            ...
            <table class="table table-bordered">
                ...
                <tr class="align-middle">
                    ...
                    <?php } ?>
                    <td>
                        <a href="news_mark_edit.php?id=<?php echo $rs[$i]['id'];  ?>" class="btn"  style="width=11%">
