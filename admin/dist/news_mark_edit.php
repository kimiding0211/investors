...
$id = $_GET['id'];
$sql = " select * from news_mark where id=$id ";
...
<div class="card card-primary card-outline mb-4">
    ...
    <!--end::Header-->
    <!--begin::Form-->
    <form action="news_mark_edit_1.php" method="post">
    <!--begin::Body-->
    <div class="card-body">
        <input type="id" name="id" class="form-control" hidden="hidden" value="<?php echo $id; ?>"/>
        <div class="mb-3">
        <label class="form-label">分類名稱</label>
        <input name="mark_name" class="form-control" value="<?php echo $rs[0]['mark_name']; ?>"/>
        </div>
